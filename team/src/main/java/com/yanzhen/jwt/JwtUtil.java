...
public class JwtUtil {
    ...
    //过期时间设置
    public static final long EXPIRE = 1000 * 60 * 60 ;//30分钟
    //生成密码
...
//        System.out.println("token："+token);
        String token="eyJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2NTkxNjU2OTQsImV4cCI6MTY1OTE2NzQ5NCwidXNlcm5hbWUiOiJhZG1pbiIsInR5cGUiOjEsImlkIjoxfQ.SBIcf0780BhHDYLjjXyAFzK20bAf0K5k6NXjXPGlz_8";
        //验证是否有效
