...
export const asyncRoutes = [
    ...
    children: [
      {
        ...
        meta: {
          ...
          icon: 'peoples',
          noCache: true ,
          roles: ['Admin','manager'] //或者你可以给每一个子路由设置自己的权限
        }
      }
    ]
  },
  ...
  },
  {
    path: '/acitityinfo',
    component: Layout,
    redirect: '/acitityinfo/index',
    children: [
      {
        path: 'index',
        component: () => import('@/views/acitityinfo/index'),
        name: 'Guide',
        meta: {
          title: '社团活动管理',
          icon: 'peoples',
    ...
    children: [
      {
        ...
        meta: {
          ...
          icon: 'peoples',
          noCache: true ,
          roles: ['manager'] //或者你可以给每一个子路由设置自己的权限
        }
      }
    ]
  },
  ...
  //       name: 'Icons',
  //       meta: { title: 'ceshi', icon: 'icon', noCache: true }
  //     }
  //   ]
  // },
  // {
